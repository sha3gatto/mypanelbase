...
<head>
	...
	<script type="text/javascript">
        ...
        if (typeof Solo.loadScripts == 'undefined') {
            Solo.loadScripts = [];
        }
	</script>
...
// Template scripts
		?>
		<!--
	<script type="text/javascript" src="<?php echo content_url() . '/js/jquery/jquery.js' ?>?<?php echo $mediaquery ?>"></script>
	-->
		<script type="text/javascript"
		...
		<script type="text/javascript"
				src="<?php echo Uri::base(); ?>media/js/bootstrap.min.js?<?php echo $mediaquery ?>"></script>
	<?php
	else:
	?>
		<!--
	...
	<link rel="stylesheet" type="text/css"
		  href="<?php echo Uri::base(); ?>/media/css/bootstrap-namespaced.min.css?<?php echo $mediaquery ?>"/>
	<link rel="stylesheet" type="text/css"
		  href="<?php echo Uri::base(); ?>/media/css/font-awesome.min.css?<?php echo $mediaquery ?>"/>
	...
	<!--[if lt IE 9]>
	<script type="text/javascript"
			src="<?php echo Uri::base(); ?>media/js/html5shiv.min.js?<?php echo $mediaquery ?>"></script>
	<script type="text/javascript"
			src="<?php echo Uri::base(); ?>media/js/respond.min.js?<?php echo $mediaquery ?>"></script>
	<![endif]-->
</head>
<body>
